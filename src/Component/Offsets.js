    ...
    <div className="app-container">
      ...
      <div class="row">
        ...
        <div class="col-sm-4 py-0">
          <div class="card fixed-card  ">
            <div class="card-body ">
              <img src="/images/one.png" class="card-img-top" alt="..."></img>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
        ...
        <div class="col-sm-4">
          <div class="card fixed-card">
            <div class="card-body">
              <img src="/images/CEO.png" class="card-img-top" alt="..."></img>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card fixed-card">
            <div class="card-body">
              <img src="/images/Flyer.png" class="card-img-top" alt="..."></img>
            </div>
          </div>
        </div>
      </div>
